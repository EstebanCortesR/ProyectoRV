...
public class PlayerController : MonoBehaviour
{
    ...
    private float _verticalRotation = 0f; // Nueva variable para controlar la rotación vertical.
    ...
    private void Update()
    {
        ...
        _verticalRotation = Mathf.Clamp(_verticalRotation, -90f, 90f); // Limitar la rotación vertical
